        ...
        if($inbound_id == 0) {
            ...
            if($protocol == 'vless'){
                ...
                if($netType == 'tcp'){
                    ...
                    else $outputlink = "$protocol://$uniqid@$server_ip:443?type=xhttp&mode=auto&security=tls&encryption=none&path=%2FCconfig%3Fed%3D2048&host=real-magic.global.ssl.fastly.net&sni=$sni#$remark
                    
🚨مهم: لطفا برای کارکرد این سرور «تنظیم سرور عادی» را از قسمت «🧩آموزش ها» در منوی اصلی ربات مشاهده و انجام دهید";
                }
                elseif($netType == 'kcp')
